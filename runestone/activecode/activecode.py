...
def setup(app):
    ...
    app.add_js_file("https://cdn.jsdelivr.net/npm/handsontable@7.2.2/dist/handsontable.full.js")
    app.add_css_file("https://cdn.jsdelivr.net/npm/handsontable@7.2.2/dist/handsontable.full.min.css")
